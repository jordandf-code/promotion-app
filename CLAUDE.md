...
Layers 0–3 complete (2I Calendar deferred). All 22 roadmap features shipped. Layer 4 scoped (4A Viewer Access, 4B View Others) but deferred. Issue triage (2026-04-09) produced prioritized bug/fix backlog — see `docs/PLAN.md` "Issue triage" section. Waves 1-2 complete: P0 bugs fixed (#62, #80, #55); P1 features (#85 thresholds, #60 exchange rate, #70 year range, ibmCriteria→promotionCriteria rename, #71 report context); P2 polish (#83, #84, #61, #59). Migrations required: `migration_layer0e.sql`, `migration_1c_feedback.sql`, `migration_1g_ai_log.sql`.
